...
const Navbar = () => {
  return (
    <div className="w-full flex justify-center">
      {" "}
      <div className="w-[80%] h-[65px] top-5 z-50 px-6">
        {" "}
        <div className="w-full h-full flex items-center justify-between m-auto px-[10px] rounded-lg">
          {" "}
          <div className="flex items-center">
            ...
            >
              ...
              <span className="text-[25px] font-bold text-[#151531] ml-2">
                June
              </span>
            </a>
          </div>
          ...
          <div className="flex items-center justify-between gap-5">
            <a
              href="#login"
              className="cursor-pointer justify-between font-bold hover:underline"
            >
              Login
            </a>
            <Button
